...
})(exports.CustomerType || (exports.CustomerType = {}));
...
var CookieService = /** @class */ (function () {
    function CookieService(config) {
        ...
        this.domain = '';
        this.secure = true;
        this.maxAge = undefined; // Ensure maxAge is a number or undefined
        this.cookie = Cookie();
        if (config) {
            if (config.path) {
    ...
    CookieService.prototype.parseMaxAge = function (maxAge) {
        if (typeof maxAge === 'string') {
            var parsed = parseInt(maxAge, 10);
    ...
    CookieService.prototype.set = function (cookie, config) {
        var options = config ? __assign(__assign(__assign({}, this.getConfig()), config), { maxAge: config.maxAge !== undefined ? this.parseMaxAge(config.maxAge) : undefined }) : this.getConfig();
        if (cookie.domain) {
...
var MerchantApiClient = /** @class */ (function () {
    function MerchantApiClient(apiUrl, apiKey) {
        this.fetchPolicy = exports.FetchPolicy.NETWORK_ONLY;
        this.pollInterval = 0;
...
var GeinsCore = /** @class */ (function () {
    function GeinsCore(credentials, channel, defualtMarketLanguage) {
        ...
        this.environment =
            credentials.environment || exports.Environment.PRODUCTION;
...
exports.GeinsCore = GeinsCore;
exports.GeinsRouter = GeinsRouter;
exports.IMAGE_URL = IMAGE_URL;
exports.MANAGEMENT_API_URL = MANAGEMENT_API_URL;
