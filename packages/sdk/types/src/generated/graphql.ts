...
export interface GeinsBalanceTypeType {
  ...
  totalSellingPriceExBalanceIncVatFormatted?: Maybe<
...
export interface GeinsMutationAddPackageToCartArgsType {
  ...
  selections?: InputMaybe<
    Array<InputMaybe<GeinsProductPackageSelectionTypeType>>
  >;
}
...
export type GeinsGetChannelsVariablesType =
...
export type GeinsUserGetVariablesType =
  | Exact<{ [key: string]: never }>
  | undefined;
